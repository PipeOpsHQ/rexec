<script lang="ts">
    ...
    const icons: Record<string, string> = {
        ...
        neovim: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2.214 4.954v13.615L7.655 24V10.314L3.312 3.845 2.214 4.954zm4.999 17.98l-4.557-4.548V5.136l.59-.596 3.967 5.908v12.486zm14.573-4.457l-.862.937-4.24-6.376V0l5.068 5.092.034 13.385zM7.431.001l12.998 19.835-3.637 3.637L3.895 3.669 7.43.001z"/></svg>`,
